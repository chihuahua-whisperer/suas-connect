                          ...
                          return Padding(
                            ...
                            child: FutureBuilder<List<QueriesRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<QueriesRow> containerQueriesRowList =
                                    snapshot.data!;
                                final containerQueriesRow =
                                    containerQueriesRowList.isNotEmpty
                                        ? containerQueriesRowList.first
                                        : null;
                                return InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'FEED_PAGE_Container_k2uwlukw_ON_TAP');
